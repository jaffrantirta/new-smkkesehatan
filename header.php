        ...
        <div class="container">
            <div class="top-bar-content">
                <div class="top-bar-left">
                    <?php
                    $instagram = get_theme_mod('smk_header_instagram', '');
                    $facebook = get_theme_mod('smk_header_facebook', '');
                    $youtube = get_theme_mod('smk_header_youtube', '');
                    $tiktok = get_theme_mod('smk_header_tiktok', '');
                    ?>
                    <?php if ($instagram || $facebook || $youtube || $tiktok): ?>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="primaryNavbar">
                ...
                ?>
                <?php
                $cta_text = get_theme_mod('smk_header_cta_text', 'Ayo Daftar !');
                $cta_url = get_theme_mod('smk_header_cta_url', '#');
                ?>
                <?php if ($cta_text): ?>
                    <a href="<?php echo esc_url($cta_url); ?>" class="btn btn-primary btn-cta ms-lg-3">
